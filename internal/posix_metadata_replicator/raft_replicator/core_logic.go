...
func (r *RaftPosixMetadataReplicator) becomeFollower(term int64) {
	r.state = Follower
	r.currentTerm = term
	r.votedFor = ""
...
func (r *RaftPosixMetadataReplicator) becomeCandidate() {
	r.state = Candidate
	r.currentTerm++
	r.votedFor = r.id
...
func (r *RaftPosixMetadataReplicator) getLastLogIndex() int64 {
	if len(r.log) > 0 {
...
func (r *RaftPosixMetadataReplicator) getLastLogTerm() int64 {
	if len(r.log) > 0 {
...
func (r *RaftPosixMetadataReplicator) getLogTerm(index int64) int64 {
	if index == 0 {
		return 0
	}
...
func (r *RaftPosixMetadataReplicator) isLogUpToDate(cLastIndex, cLastTerm int64) bool {
...
func (r *RaftPosixMetadataReplicator) applyLogs() {
