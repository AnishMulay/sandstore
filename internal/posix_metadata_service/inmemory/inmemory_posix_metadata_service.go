...
type InMemoryPosixMetadataService struct {
	// State
	mu         sync.RWMutex
...
func NewInMemoryPosixMetadataService(
	replicator pmr.MetadataReplicator,
	ls log_service.LogService,
) *InMemoryPosixMetadataService {
	return &InMemoryPosixMetadataService{
...
func (s *InMemoryPosixMetadataService) Start() error {
...
func (s *InMemoryPosixMetadataService) Stop() error {
	return s.replicator.Stop()
}

// --- Replication Helper ---

func (s *InMemoryPosixMetadataService) replicateOp(ctx context.Context, op pms.MetadataOperation) error {
	// Tag with metadata
...
func (s *InMemoryPosixMetadataService) ApplyTransaction(data []byte) error {
...
func (s *InMemoryPosixMetadataService) applyCreate(op pms.MetadataOperation) error {
	// 1. Check Parent
...
func (s *InMemoryPosixMetadataService) applyRemove(op pms.MetadataOperation) error {
	parent, exists := s.inodes[op.ParentID]
	if !exists {
...
func (s *InMemoryPosixMetadataService) applyRename(op pms.MetadataOperation) error {
...
func (s *InMemoryPosixMetadataService) applySetAttr(op pms.MetadataOperation) error {
...
func (s *InMemoryPosixMetadataService) applyUpdateInode(op pms.MetadataOperation) error {
	inode, exists := s.inodes[op.InodeID]
	if !exists {
		return nil
	}
...
func (s *InMemoryPosixMetadataService) GetAttributes(ctx context.Context, inodeID string) (*pms.Attributes, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s *InMemoryPosixMetadataService) Lookup(ctx context.Context, parentInodeID string, name string) (string, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s *InMemoryPosixMetadataService) LookupPath(ctx context.Context, path string) (string, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s *InMemoryPosixMetadataService) Access(ctx context.Context, inodeID string, uid, gid uint32, accessMask uint32) error {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s *InMemoryPosixMetadataService) GetInode(ctx context.Context, inodeID string) (*pms.Inode, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s *InMemoryPosixMetadataService) ReadDir(ctx context.Context, inodeID string, cookie int, maxEntries int) ([]pms.DirEntry, int, bool, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s *InMemoryPosixMetadataService) ReadDirPlus(ctx context.Context, inodeID string, cookie int, maxEntries int) ([]pms.DirEntryPlus, int, bool, error) {
...
func (s *InMemoryPosixMetadataService) GetFsStat(ctx context.Context) (*pms.FileSystemStats, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s *InMemoryPosixMetadataService) GetFsInfo(ctx context.Context) (*pms.FileSystemInfo, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s *InMemoryPosixMetadataService) GetChunkList(ctx context.Context, inodeID string) ([]string, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s *InMemoryPosixMetadataService) Create(ctx context.Context, parentInodeID string, name string, mode uint32, uid, gid uint32) (*pms.Inode, error) {
...
func (s *InMemoryPosixMetadataService) Mkdir(ctx context.Context, parentInodeID string, name string, mode uint32, uid, gid uint32) (*pms.Inode, error) {
	newID := uuid.New().String()
	op := pms.MetadataOperation{
...
func (s *InMemoryPosixMetadataService) Remove(ctx context.Context, parentInodeID string, name string) error {
	op := pms.MetadataOperation{
		Type:     pms.OpRemove,
		ParentID: parentInodeID,
		Name:     name,
...
func (s *InMemoryPosixMetadataService) Rmdir(ctx context.Context, parentInodeID string, name string) error {
...
func (s *InMemoryPosixMetadataService) Rename(ctx context.Context, srcParentID, srcName, dstParentID, dstName string) error {
	op := pms.MetadataOperation{
		Type:        pms.OpRename,
...
func (s *InMemoryPosixMetadataService) SetAttributes(ctx context.Context, inodeID string, mode *uint32, uid, gid *uint32, atime, mtime *int64) (*pms.Attributes, error) {
	op := pms.MetadataOperation{
		Type:     pms.OpSetAttr,
		InodeID:  inodeID,
		SetMode:  mode,
...
func (s *InMemoryPosixMetadataService) UpdateInode(ctx context.Context, inodeID string, newSize int64, newChunkList []string, mtime int64) error {
	op := pms.MetadataOperation{
