...
type DefaultReplicatedServer struct {
...
func NewDefaultReplicatedServer(comm communication.Communicator, fs file_service.FileService, nr node_registry.NodeRegistry) *DefaultReplicatedServer {
	ctx, cancel := context.WithCancel(context.Background())
	return &DefaultReplicatedServer{
		comm:          comm,
		fs:            fs,
		ctx:           ctx,
		cancel:        cancel,
...
func (s *DefaultReplicatedServer) Start() error {
	return s.comm.Start(s.handleMessage)
}

func (s *DefaultReplicatedServer) Stop() error {
	s.cancel()
	return s.comm.Stop()
}

func (s *DefaultReplicatedServer) RegisterTypedHandler(msgType string, payloadType reflect.Type, handler func(msg communication.Message) (*communication.Response, error)) {
...
func (s *DefaultReplicatedServer) handleMessage(msg communication.Message) (*communication.Response, error) {
...
func (s *DefaultReplicatedServer) HandleStoreFileMessage(msg communication.Message) (*communication.Response, error) {
...
func (s *DefaultReplicatedServer) HandleReadFileMessage(msg communication.Message) (*communication.Response, error) {
...
func (s *DefaultReplicatedServer) HandleDeleteFileMessage(msg communication.Message) (*communication.Response, error) {
