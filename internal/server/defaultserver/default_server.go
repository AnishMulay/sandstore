...
func (s *DefaultServer) Start() error {
	s.ls.Info(log_service.LogEvent{Message: "Starting default server"})
	...
	s.ls.Info(log_service.LogEvent{Message: "Default server started successfully"})
	return nil
}

func (s *DefaultServer) Stop() error {
	s.ls.Info(log_service.LogEvent{Message: "Stopping default server"})
	...
	s.ls.Info(log_service.LogEvent{Message: "Default server stopped successfully"})
	return nil
}
...
var _ server.Server = (*DefaultServer)(nil)
